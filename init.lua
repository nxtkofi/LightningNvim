...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
							...
							mappings = {
								i = {
									["<CR>"] = function(prompt_bufnr)
										...
										-- Ustaw ścieżkę repozytorium jako główny katalog Neo-tree
										vim.cmd("Neotree close") -- Zamknij Neo-tree, jeśli jest otwarte
			...
			end, { noremap = true, silent = true, desc = "Open url in firefox" })
			vim.keymap.set(
				"n",
				"<leader>sgr",
